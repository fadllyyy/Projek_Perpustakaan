                ...
                itemBuilder: (context, rowIndex) {
                  return Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Popular section with text above it
                        Padding(
                          padding: const EdgeInsets.all(16.0),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(
                                'Sedang Populer', // First text for popular
                                style: TextStyle(
                                  fontSize: 18, // Larger font size for "Sedang Populer"
                                  fontWeight: FontWeight.bold, // Bold text
                                  color: customTextColor, // Custom text color
                                ),
                              ),
                              const SizedBox(height: 4), // Small gap between texts
                              Text(
                                'Paling banyak dicari', // Second text for most searched
                                style: TextStyle(
                                  fontSize: 14, // Smaller font size for the second line
                                  color: Colors.black, // Grey color for the second line
                                ),
